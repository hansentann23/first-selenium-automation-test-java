...
public class HomePage extends BasePage {
    ...
    private By alertsFrameWindowsCard = By.xpath("//div[@id='app']//h5[contains(text(),\"Alerts, Frame & Windows\")]");
    ...
    public ElementsPage goToElement(){
        scrollToElementJS(elementsCard);
        click(elementsCard);
        return new ElementsPage();
    }

    public WidgetsPage goToWidget(){
